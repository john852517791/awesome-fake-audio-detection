...
def get_weekly_deepfake_papers():
    ...
    # 2. 构建搜索查询
    # ti: 标题搜索，abs: 摘要搜索
    query = '(ti:"deepfake speech detection" OR abs:"deepfake speech detection" OR ti:"audio deepfake" OR ti:"fake audio"  OR ti:"Speech Deepfake Detection" OR ti:"Speech Anti-Spoofing"  OR ti:"audio antispoof"  OR ti:"speech antispoof" )'
    client = arxiv.Client()
    search = arxiv.Search(
        query = query,
        max_results = 500,
    ...
    logging.info(f"开始抓取自 {last_week.date()} 以来的论文...")
